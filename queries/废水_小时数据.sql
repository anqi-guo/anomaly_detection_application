SELECT
	...
	JCJ.PJLLORPFLXYZ 流量
FROM
	( SELECT JCDXH, WRWBH, XYZ AS JCZ, JCSJ, WRWPFL FROM T_ZXJC_JCSJ_FS_SSJ_JCZ WHERE JCZ IS NOT NULL ) JCZ
	LEFT JOIN ( SELECT XTXH, JCSJ, LLORPFLXYZ, PJLLORPFLXYZ FROM T_ZXJC_JCSJ_FS_SSJ_JCJ ) JCJ ON JCZ.JCDXH = JCJ.XTXH AND JCZ.JCSJ = JCJ.JCSJ
